...
Route::get('/api/countries', [SurveyController::class, 'countries']);
Route::get('/api/psgc/regions', [SurveyController::class, 'psgcRegions']);
Route::get('/api/psgc/regions/{regionCode}/provinces', [SurveyController::class, 'psgcProvinces']);
Route::get('/api/psgc/provinces/{provinceCode}/cities-municipalities', [SurveyController::class, 'psgcMunicipalities']);
Route::get('/api/psgc/cities-municipalities/{municipalityCode}/barangays', [SurveyController::class, 'psgcBarangays']);
